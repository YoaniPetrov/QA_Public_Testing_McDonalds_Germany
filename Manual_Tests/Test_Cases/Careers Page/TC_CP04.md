Test Case ID : TC_CP4.md

Prerequisites : none

Title : Career search function validation - without providing location data.
...
Expected result : All of the available job oppenings with the correct name are displayed.
